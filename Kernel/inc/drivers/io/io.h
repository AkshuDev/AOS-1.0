...
void serial_init(aos_bool preinit) __attribute__((used));
...
void vmem_scroll_up(struct VMemDesign* design, uint32_t lines, enum VMemColors color) __attribute__((used));
